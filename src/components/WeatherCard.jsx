        ...
        <section className='card__info'>
          ...
          <ul className='card__info-body'>
            <li className='card__info-item'>
              <span className='card__info-label'>Wind Speed</span> {weather?.wind.speed}m/s</li>
            <li className='card__info-item'>
              <span className='card__info-label'>Clouds</span> {weather?.clouds.all}%</li>
            <li className='card__info-item'>
              <span className='card__info-label'>Pressure</span> {weather?.main.pressure}hPa</li>
          </ul>
        </section>
      </div>
